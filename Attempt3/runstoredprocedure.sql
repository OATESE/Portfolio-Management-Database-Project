CREATE OR ALTER PROCEDURE FillMissingPrices
AS
BEGIN
    ...
    SELECT DISTINCT Date FROM [PRACTICE3].[Prices] ORDER BY Date;
    ...
    SELECT DISTINCT Asset_Symbol FROM [PRACTICE3].[Prices];
    ...
    BEGIN
        ...
        BEGIN
            ...
            IF NOT EXISTS (SELECT 1 FROM [PRACTICE3].[Prices] WHERE Asset_Symbol = @CurrentAsset AND Date = @CurrentDate)
            BEGIN
